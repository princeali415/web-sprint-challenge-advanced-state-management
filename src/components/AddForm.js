    ...
    render() {
        ...
        <section>
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                {this.props.error ? 
                <div data-testid="errorAlert" className="alert alert-danger" role="alert">Error: {this.props.error.response.data.Error} {console.log(this.props.error.response.data.Error)}</div> : <></>}
